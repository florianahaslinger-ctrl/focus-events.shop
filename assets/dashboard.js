...
(function () {
  ...
  function vipTableRowHTML(t) {
    ...
    return '<div class="vip-table-row" data-id="' + esc(t.id || '') + '" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">' +
      ...
      '<input type="number" class="vt-min" min="0" step="1" placeholder="Mindestkonsum €" value="' + (t.minConsumption != null ? t.minConsumption : '') + '" style="flex:1 1 140px" title="Mindestkonsum in €">' +
